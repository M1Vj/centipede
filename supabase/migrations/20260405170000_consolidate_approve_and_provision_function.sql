-- Canonical forward-only consolidation migration for approve_and_provision_organizer_application.
begin;

drop function if exists public.approve_and_provision_organizer_application(uuid, uuid);
